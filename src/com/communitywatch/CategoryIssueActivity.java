...
public class CategoryIssueActivity extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		proceed.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(CategoryIssueActivity.this, AddIssue.class);
				startActivity(i);
			}
		});
	...
	private class GetCategories extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CategoryIssueActivity.this);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		SharedPreferences ct = PreferenceManager
				.getDefaultSharedPreferences(CategoryIssueActivity.this);
		Editor edit = ct.edit();
