...
public class LikesIssueDataBaseAdapter 
{
		static final String DATABASE_NAME = "likes.db";
		...
		public  LikesIssueDataBaseAdapter(Context _context) 
		{
			context = _context;
			dbHelper = new LikeIssueDataBaseHelper(context, DATABASE_NAME, null, DATABASE_VERSION);
		}
		public  LikesIssueDataBaseAdapter open() throws SQLException 
		{
