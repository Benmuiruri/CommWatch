...
public class SuggestionCategoryActivity extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinnerFood = (Spinner) findViewById(R.id.spinCategory);
		...
		proceed.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent i = new Intent(SuggestionCategoryActivity.this, AddSuggestion.class);
				startActivity(i);
			}
		});
	...
	private class GetCategories extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(SuggestionCategoryActivity.this);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		SharedPreferences ct = PreferenceManager
				.getDefaultSharedPreferences(SuggestionCategoryActivity.this);
		Editor edit = ct.edit();
